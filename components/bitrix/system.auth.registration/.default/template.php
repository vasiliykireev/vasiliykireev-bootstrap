			...
			<div class="register__col col-12 col-sm-auto col-xl-4">
				<div class="__card card p-3 border-1">
					...
					<?if($arResult["SHOW_SMS_FIELD"] == true):?>
						...
						<form class="register__sms-form" method="post" action="<?=$arResult["AUTH_URL"]?>" name="regform">
					...
					<?elseif(!$arResult["SHOW_EMAIL_SENT_CONFIRMATION"]):?>
						<form class="register__email-form" method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data">
							...
							<div class="register__submit form-submit text-center mb-4">
								<input class="register__submit-button btn btn-primary w-100" type="submit" name="Register" value="<?=GetMessage("AUTH_REGISTER")?>">
							</div>
